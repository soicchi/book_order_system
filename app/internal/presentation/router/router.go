...
// /api
func NewRouter(e *echo.Echo, logger logger.Logger) {
	base := e.Group("/api")
...
// /api/v1
func v1Router(base *echo.Group, logger logger.Logger) {
	v1 := base.Group("/v1")
...
func customerRouter(version *echo.Group, logger logger.Logger) {
